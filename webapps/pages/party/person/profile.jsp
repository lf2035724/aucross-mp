	...
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				initGeo({
					'geo_parent_url':'<s:url value="/settings/geo/listcountry.do"/>',
					...
					'geo_selectors':[
						...
						{'name':'party.thirdGeo.code','value':'<s:property value="%{party.thirdGeo.code}"/>','types':['CITY']},
						{'name':'party.fourthGeo.code','value':'<s:property value="%{party.fourthGeo.code}"/>','types':['CITY']}
						]
				});
			});
