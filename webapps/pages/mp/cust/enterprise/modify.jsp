	...
	<s:form id="frm" action="modify" method="post" enctype="multipart/form-data">
		<table class="profile">
			<tr>
				...
				<td colspan="3" id="vo.id">${vo.id }</td>
			</tr>
			<tr>
			...
			<tr> 
				...
				<td>
					<s:checkboxlist list="@com.ylink.ylpay.common.project.account.constant.CustSubject@reservesValues()"
						name="vo.subjects" listKey="value" listValue="displayName" cssClass="required" disabled="true"></s:checkboxlist>
				</td>
				<!-- <th><label class="required">支付密码</label>
				<td>
					<s:textfield name="vo.payPassword" cssClass="required default-input" maxlength="100"/>
				</td> -->
			</tr>
			<tr>
			...
			<tr>
				...
				<td>${vo.email}<s:textfield name="vo.email" value="%{vo.email}"></s:textfield></td>
			...
			<tr>
				...
				<td>
					<s:file name="listBean[2].upload" cssClass="default-input"/>
				</td>
			...
			<tr>
				...
				<td>
					<s:file name="listBean[3].upload" cssClass="default-input"/>
				</td>
