...
<body>
	...
	<s:form id="frm" action="save" method="post" enctype="multipart/form-data">
		<table class="profile">
			<colgroup>
				<col width="15%">
				<col width="35%">
			...
			<tr>
				<th><label>流量费</label>
				<td><s:textfield id="flowFee" name="workOrder.flowFee" cssClass="default-input" maxlength="100"/></td>
				<th><label>月租费</label>
				<td>
					<s:textfield id="workOrder.monthlyFee" name="workOrder.monthlyFee" cssClass="default-input" maxlength="100"/>
				</td>
			</tr>
			<tr>
				<th><label>截止日期</label>
				...
				<th><label>计费周期</label>
				<td>
					<s:textfield id="workOrder.billingCycleee" name="workOrder.billingCycleee" cssClass="default-input" maxlength="100"/>
				</td>
			</tr>
			<tr> 
		...
		<p class="submit">
			<s:submit value="保存" cssClass="action save" onclick="return clickSave();"></s:submit>
		</p>
