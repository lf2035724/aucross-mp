...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function doResend(id,subject){
				var url = '<s:url value="/mp/settings/email/resend.do"/>?emailContent.id='+id;
	...
	<body>
		...
		<s:form name="list" namespace="/mp/settings/email" method="post">
			<table class="profile">
				<tbody>
					<tr>
			...
			<mys:column title="操作" width="40px" cssClass="action">
				...
				<div class="popup-menu-layer">
					<ul class="dropdown-menu">
						...
						<s:set name="resend" value="@com.ylink.ylpay.project.mp.email.entity.Status@FAILURE.equals(status)"/>
						<s:if test="#resend">
							<li class="section"></li>
							<li>
