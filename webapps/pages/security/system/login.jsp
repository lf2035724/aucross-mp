...
<body style="text-align: left;" id="login">
	<div id="header_login">
	<div class="logo">
				...
				<s:form id="login_form" action="login" namespace="/" method="post" onsubmit="return dosubmit();">
					<ul>
						...
						<li>
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="企业邮箱" id="" class="action login" onclick="window.open('https://qiye.aliyun.com')"/>
						</li>
					</ul>
				</s:form>
			</div>
	...
	<div id="login_footer">
		Copyright &copy;2016-<s:property value="@com.google.code.lightssh.common.util.TextFormater@format(new java.util.Date(),'yyyy')"/>
		<a href="http://www.sswte.com/">www.sswte.com</a>,
		版本(<s:property value="version"/>).
	</div>
