		...
		<table class="profile">
			<tbody>
				...
				<tr>
					...
					<td>
						<s:password id="old_password" name="passwords[0]" size="40" autocomplete="off"/>
					</td>
				</tr>
				<tr>
					<th><label for="new_password" class="required">新密码</label></th>
					<td>
						<s:password id="new_password" name="passwords[1]" size="40" autocomplete="off"/>
					</td>
				</tr>
				<tr>
					<th><label for="new_password2" class="required">重复新密码</label></th>
					<td>
						<s:password id="new_password2" name="passwords[2]" size="40" autocomplete="off"/>
					</td>
				</tr>
			</tbody>
		</table>
