...
<table class="profile">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<span class="compare 
					<s:property value="@com.google.code.lightssh.project.util.CompareUtil@style(#originalObject,#newObject,'realName')" />" 
					title="<s:property value="%{#originalObject.realName }" />">
				</span>
				<s:property value="%{#newObject.realName }" />
			</td>
		</tr>
		<tr>
