...
public class PartyRole  implements Persistence<Long>{
	
	private static final long serialVersionUID = 2958430040401675644L;
	...
	/* (non-Javadoc)
	 * @see com.google.code.lightssh.common.entity.Insertable#postInsertFailure()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.google.code.lightssh.common.entity.Persistence#getIdentity()
	 */
	@Override
