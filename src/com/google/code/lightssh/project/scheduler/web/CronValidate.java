...
public class CronValidate implements Serializable{
	
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -6622103185772676041L;
	...
	public static class Field{
		...
		public String validate(String value ){
			...
			if(value.contains("/")){
				...
				for(String string:split){
					if( !(isAllowedValue(string)||isAllowedSymbol(string)) )
		...
		public static int has(String value,String str){
			int num = 0;
			for(int i=0;i<value.length();i++){
				if(str.equals(value.charAt(i))){
					num++;
				}
			}
			return num;
	...
	public CronValidate(String seconds,String minutes,String hours,
